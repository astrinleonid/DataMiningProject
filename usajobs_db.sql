...
-- Table `mydb`.`duties`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`duties` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`job_card` (
  ...
  `open_closing_dates` VARCHAR(45) NULL,
  ...
  `job_family_series_id` INT NULL COMMENT 'Job family  as indicated in the overview\nRefers to the table',
  `remote` INT NULL,
  ...
  INDEX `job_fam_idx` (`job_family_series_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`job_family_series` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`pay_scale_grade` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`professional_area` ;
...
-- Table `mydb`.`summary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`summary` ;
